...
class ResonatorCoilByTurnsWithWirebonds(QComponent):
    ...
    def make(self):
        ...
        start_point_wb = (-x_point, -y_point)
        ...
        end_point_wb = (start_point_wb[0], y_point+p.wb_extra/2)
        ...
        wb_geom = draw.LineString([start_point_wb, end_point_wb])
        ...
        self.add_qgeometry('wirebond', {'wb_extra': wb_geom}, height=p.wb_height, thickness=p.wb_thickness)
